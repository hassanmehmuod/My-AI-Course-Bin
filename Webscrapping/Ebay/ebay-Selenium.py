...
smartphoneList=[]
smartphoneDiv= driver.find_elements(By.XPATH, "//li[contains(@class, 'brwrvr__item-card')]" )
...
filename = 'D:\\Work\\Github\\My-AI-Course-Bin\\Webscrapping\\Ebay\\smart-phonesData-Selenium.csv'
